...
use Pangaea\ConsoleCommands\Console\Interfaces\ConsoleInterface as KernelConsole;
...
{
    /**
     * All teams registered in the console
     *
     * @var Command[]
     */
    ...
    const PACKAGE_NAMESPACE = 'Pangaea\ConsoleCommands';
